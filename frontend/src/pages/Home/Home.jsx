    ...
    <section className="container__pages home">
      ...
      <div className="home__body">
        ...
        <p className="home__body-content">
          ...
          aéronefs militaires français, il possède une connaissance approfondie
          des exigences physiologiques, psychologiques et opérationnelles liées
          au vol, ainsi qu’à la gestion du stress et de la performance en
        ...
        <p className="home__body-content">
          Aujourd’hui, le Docteur Laurent Lely exerce en cabinet médical avec la
          même rigueur, la même exigence et la même passion, en proposant à ses
          patients une prise en charge personnalisée, fondée sur l’écoute, la
          confiance et la qualité des soins.
        </p>
